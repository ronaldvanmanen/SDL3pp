...
typedef boost::mpl::list<
    pixel_format_constant<sdl3::pixel_format::rgb96f>,
    pixel_format_constant<sdl3::pixel_format::bgr96f>
>
    test_pixel_formats;

BOOST_AUTO_TEST_SUITE(rgb_array_color)

    SDL3PP_AUTO_TEST_CASE_TEMPLATE(test_default_constructor, PixelFormat, test_pixel_formats)
    {
        using packed_color_t = sdl3::rgb_array_color<PixelFormat::value>;
