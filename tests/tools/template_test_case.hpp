...
namespace sdl3::unit_test::tools
{
    ...
    struct test_type_name_generator
    {
        ...
        value()
        {
            ...
            full_name = boost::unit_test::utils::replace_all_occurrences_of(
                full_name,
                to_replace,
                to_replace + sizeof(to_replace) / sizeof(to_replace[0]),
                replacement,
                replacement + sizeof(replacement) / sizeof(replacement[0])
            );
    ...
    {
        explicit typed_test_case_generator(
        ...
        template <typename TestType>
        void
        operator()(boost::mpl::identity<TestType>)
        {
            ...
            m_holder.m_test_cases.push_back(new boost::unit_test::test_case(
    ...
    public:
        ...
        )
        {
            typedef typed_test_case_generator<
                template_test_case_generator<TestCaseTemplate, TestTypesList>,
                TestCaseTemplate
            >
                single_test_case_generator;

            boost::mpl::for_each<TestTypesList, boost::mpl::make_identity<boost::mpl::_>>(
...
#define SDL3PP_FIXTURE_TEST_CASE_TEMPLATE(test_name, type_name, type_list, fixture)   \
    ...
    struct BOOST_PP_CAT(test_name, _case)                                             \
    : public fixture                                                                  \
    {                                                                                 \
        void test_method();                                                           \
    };                                                                                \
    ...
    BOOST_AUTO_TEST_SUITE(test_name, *boost::unit_test::decorator::stack_decorator()) \
        ...
        BOOST_AUTO_TU_REGISTRAR(BOOST_PP_CAT(test_name, _case))(                      \
            sdl3::unit_test::tools::template_test_case_generator<                     \
                BOOST_AUTO_TC_INVOKER(BOOST_PP_CAT(test_name, _case)),                \
                type_list                                                             \
...
#define SDL3PP_AUTO_TEST_CASE_TEMPLATE(test_name, type_name, type_list)                              \
    SDL3PP_FIXTURE_TEST_CASE_TEMPLATE(test_name, type_name, type_list, BOOST_AUTO_TEST_CASE_FIXTURE) \
/**/
