...
namespace sdl3
{
    namespace details
    {
        ...
        inline
        SDL_Texture* create_texture(renderer & owner, property_group & properties)
        {
    ...
    inline
    texture_base::texture_base(renderer & owner, property_group & properties)
    ...
    inline
    texture_base::texture_base(texture_base && other)
